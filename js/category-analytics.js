...
async function handleAddCategoryExpense(e) {
    ...
    try {
        ...
        if (res.ok) {
            ...
            if (typeof showToast === 'function') showToast(d.error?.message || 'Failed to add transaction', 'error');
            else alert(d.error?.message || 'Failed to add transaction');
        }
    } catch (err) {
...
async function deleteTransaction(id) {
    ...
    try {
        ...
        if (res.ok) {
            ...
            if (typeof showToast === 'function') showToast(d.error?.message || 'Error deleting transaction', 'error');
            else alert(d.error?.message || 'Error deleting transaction');
        }
    } catch (err) {
